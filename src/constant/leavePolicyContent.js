...
// LeavePoliciesPage.jsx for how GENERAL_SECTIONS and TEAM_ADDENDA are
// combined, and PolicyBlock.jsx for how each block type renders.
//
// Block types:
//   p           — a paragraph
 ...
 * `employee_team` value stored on the employee record (see
 * EMPLOYEE_TEAM_OPTIONS in AddEmployees.jsx / UpdateEmployee.jsx). A team
 * with no entry here just sees the general policy unchanged — add a new
 * key the same shape as "BIM Team" once that team gets its own addendum
 * (e.g. "3D Team").
 */
