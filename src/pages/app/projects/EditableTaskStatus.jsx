...
const EditableTaskStatus = ({
  ...
  return (
    <div className="relative">
      {isSaving ? (
        <div
          className={`px-2 sm:px-3 py-1.5 rounded-full text-xs sm:text-sm font-semibold border flex items-center justify-center ${getStatusClass(
            displayStatus
          )}`}
        >
        ...
        <>
          <button
            ...
            className={`px-2 sm:px-3 py-1.5 rounded-full text-xs sm:text-sm font-semibold border focus:outline-none focus:ring-2 focus:ring-offset-1 flex items-center ${getStatusClass(
              displayStatus
            )}`} // CHANGE HERE
            aria-haspopup="true"
        ...
        <div
          className={`px-2 sm:px-3 py-1.5 rounded-full text-xs sm:text-sm font-semibold border ${getStatusClass(
            displayStatus
          )}`}
        >
          {" "}
