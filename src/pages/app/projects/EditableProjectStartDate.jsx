...
const EditableProjectStartDate = ({ projectId, currentStartDate, onDateUpdate, isEditable, userRole }) => {
  ...
  useEffect(() => {
    ...
    if (currentStartDate && !isNaN(new Date(currentStartDate))) {
  ...
  const handleDateChange = async (date) => {
    ...
    try {
      await axios.put(
        ...
        { start_date: formattedDate }, // API expects 'start_date'
