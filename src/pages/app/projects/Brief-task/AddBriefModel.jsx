    ...
    try {
      ...
      if (!response.ok) {
        let detailedMessage =
          ...
          `Failed to add brief (status ${response.status}).`;
      ...
      toast.success(
        responseData.message || "Project brief added successfully!"
      );
      ...
      <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-4">
        <FormGroup label="Brief Description" error={errors.brief_description}>
          ...
          <ReactQuill
            ...
            placeholder="Enter the details of the job brief..."
            className={`${
